...
<div class="card border-0 mb-5">
    ...
    <div class="card-body">
        ...
        <div class="row justify-content-end mt-5"><div class="col-md-5 col-lg-4"><div class="d-flex justify-content-between mb-2"><span>Total HT</span><strong id="totalHt">0,00</strong></div><div class="d-flex justify-content-between mb-2"><span>Total remise</span><strong id="totalDiscount">0,00</strong></div><div class="d-flex justify-content-between mb-2"><span>Montant net HT</span><strong id="netHt">0,00</strong></div><div class="d-flex justify-content-between align-items-center mb-2"><label for="taxRate">TVA (%)</label><input class="form-control form-control-sm w-25" type="number" name="tax_rate" id="taxRate" value="{{ isset($proforma) ? $proforma->tax_rate : 0 }}" min="0" max="100" step="0.01"></div><div class="separator my-3"></div><div class="d-flex justify-content-between fs-3"><strong>Total TTC</strong><strong id="totalTtc">0,00</strong></div></div></div>
    </div>
</div>
...
(() => {
    ...
    document.getElementById('taxRate').addEventListener('input', totals);
