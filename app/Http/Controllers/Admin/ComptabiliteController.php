    ...
    protected function buildComptabiliteHub(): array
    {
        return [
            ...
            'sections' => [[
                ...
                'icon' => 'fa-money',
                'items' => [
                    $this->makeModule('Tableau Comptabilité', 'Pilotage avancé de la trésorerie, des flux, des achats et des actifs', route('admin.comptabilite.tableau'), 'Pilotage', 'fa-line-chart', 'indigo', 'tableau comptabilite dashboard pilotage flux analyse', true, true),
                    $this->makeModule('Caisses', 'Gestion de trésorerie et des caisses', route('admin.comptabilite.caisses'), 'Finance', 'fa-money', 'blue', 'socle finance tresorerie caisse', true, true),
                    ...
                    $this->makeModule('Factures ventes', 'Gestion des factures de ventes', route('admin.commercial.module', 'factures'), 'Ventes', 'fa-file-text-o', 'cyan', 'socle ventes factures clients', true, true),
                    $this->makeModule('Import facture fournisseur', 'Téléversement PDF et enregistrement des factures fournisseurs', route('admin.comptabilite.supplierInvoices'), 'Achats', 'fa-file-pdf-o', 'pink', 'socle achats factures fournisseurs import upload', true, true),
                    $this->makeModule('Factures achats', 'Consultation et suivi des factures fournisseurs', 'admin/invoiceitem_supplier', 'Achats', 'fa-shopping-cart', 'purple', 'socle achats factures fournisseurs', true, true),
                ],
            ]],
            'workflow' => [],
        ];
