...
class CommercialOrder extends Model
{
    ...
    protected $fillable = ['entreprise_id','created_by_user_id','quote_id','reference','client_name','customer_order_code','lines','total_ttc','total_ht','tax_amount','tax_rate','tax_regime','tax_rate_id','currency','status'];
